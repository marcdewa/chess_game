...
class PawnPromotion {
	...
	void correctMovementTest() throws Exception {
		...
		//game.print.print();
		assertTrue(game.move.movingPiece(player,mc,true),"pawn promotion only happen when the pawn reach the eight rank");
	}
	...
	void FalseMovementTest() throws Exception {
		...
		//game.print.print();
		assertFalse(game.move.movingPiece(player,mc,true),"can't use pawn promotion input if the move is not pawn promorion");
	}
